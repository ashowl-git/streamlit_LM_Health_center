...
def user_input_features():
    ...
    급탕효율 = st.sidebar.slider('급탕효율', 0.0, 87.0, 100.0)
    조명밀도 = st.sidebar.slider('조명밀도', 0.0, 10.0, 20.0)
...
def user_input_features2():
    ...
    급탕효율_2 = st.sidebar.slider('급탕효율_2', 0.0, 87.0, 100.0)
    조명밀도_2 = st.sidebar.slider('조명밀도_2',  0.0, 10.0, 20.0)
